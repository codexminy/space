...
<%
	request.setAttribute("c_board_id", request.getParameter("uid"));
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div>
		<h3>신고하기</h3>
		<form id="report" name="reportForm" action="./report/process" method="POST">
			...
			<p>내용작성:</p><textarea class='report_textarea' name="n_content" placeholder="사유를 적어주세요." style="width:540px;height:40px;border:1;overflow:visible;text-overflow:ellipsis;"></textarea>			
