...
<body>
	...
	<div id="wrapinfo">
        ...
        <div class="info">
            <form action="./googleFinish" method="POST" id="infopage">
                <div class="inputinfo">
                    <input type="text" name="login_id" placeholder="아이디" id="userId" value="${email}" readonly="readonly">
                    ...
                    <input type="text" name="user_name" placeholder="이름" id="userName" value="${name}" readonly="readonly">
