...
<body>
	...
	<div class="container home-container">
		...
		<div class="list-wrap">
			...
			<button class="community-search">검색</button>
			<select name="amount">
	...
	<script type="text/javascript">
		...
		function getLoad(page) {
			...
			$.ajax({
				url : "${path}/admin/page/board/community",
				data: {
					pageNum: page,
				...
				success : function(result) {
					...
					for(let i=0; i<list.length; ++i) {
						...
						listData += "<td><input type=checkbox value=" + list[i].acbDTO.c_board_id + "/></td>";
						...
						listData += "<td>" + list[i].acbDTO.c_board_title + "</td>";
						listData += "<td>" + formatDate(list[i].acbDTO.c_board_date) + "</td>";
						listData += "<td>" + list[i].acbDTO.c_board_hidden + "</td>";
						listData += "</tr>";
					}
