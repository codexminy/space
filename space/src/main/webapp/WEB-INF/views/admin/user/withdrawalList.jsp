...
<body>
	...
	<div class="container home-container">
		...
		<div class="list-wrap">
			...
			<button class="user-search">검색</button>
			<select name="amount">
	...
	<script type="text/javascript">
		...
		function getLoad(page) {
			...
			$.ajax({
				url : "${path}/admin/page/user/withdrawalList",
				data: {
					pageNum: page,
				...
				success : function(result) {
					...
					searchData += '<option value="T" ' + (paging.ps.type == "B" ? "selected" : "") + '>아이디</option>';
					...
					for(let i=0; i<list.length; ++i) {
						...
						listData += "<td>" + list[i].daDTO.delete_reason + "</td>";
						listData += "<td>" + formatDate(list[i].daDTO.delete_date) + "</td>";
						listData += "</tr>";
					}
