...
<body>
	...
	<script type="text/javascript">
		...
		$.ajax({
			url : "${path}/admin/notify/notify/cmt",
			success : function(result) {
				...
				list.forEach(list => {
					if(list.nc_id === parseInt("${nc_id}")) {
						...
						tbodyData += '<tr>';
						tbodyData += '<td>접수일</td>';
						tbodyData += '<td>'+ formatDate(list.nc_notify_date) +'</td>';
						tbodyData += '</tr>';
						tbodyData += '<tr>';
						tbodyData += '<td>신고자</td>';
						...
						let content = list.nc_content === null ? '' : list.nc_content;
